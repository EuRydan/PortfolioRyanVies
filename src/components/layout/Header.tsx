...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div 
        className={`fixed top-0 right-0 h-full w-[85vw] sm:w-[50vw] md:w-[40vw] bg-zinc-900 shadow-2xl z-50 transform transition-transform duration-500 ease-in-out flex flex-col ${
      ...
      >
        ...
        <div className="flex flex-col flex-1 w-full px-10 sm:px-16 md:px-24">
          <nav className="flex flex-col justify-center items-start gap-6 md:gap-8 flex-1 overflow-y-auto">
            ...
            <Link href="/#quem-somos" className="text-4xl md:text-5xl lg:text-6xl font-bold text-zinc-300 hover:text-[#d75310] transition-colors" onClick={() => setIsDrawerOpen(false)} style={{ fontFamily: 'var(--font-manrope), sans-serif' }}>
              Quem Somos
            </Link>
            <Link href="/#portfolio" className="text-4xl md:text-5xl lg:text-6xl font-bold text-zinc-300 hover:text-[#d75310] transition-colors" onClick={() => setIsDrawerOpen(false)} style={{ fontFamily: 'var(--font-manrope), sans-serif' }}>
              Portfólio
            </Link>
            <Link href="/#o-que-fazemos" className="text-4xl md:text-5xl lg:text-6xl font-bold text-zinc-300 hover:text-[#d75310] transition-colors" onClick={() => setIsDrawerOpen(false)} style={{ fontFamily: 'var(--font-manrope), sans-serif' }}>
              O Que Fazemos
            </Link>
            <Link href="/fale-conosco" className="text-4xl md:text-5xl lg:text-6xl font-bold text-zinc-300 hover:text-[#d75310] transition-colors" onClick={() => setIsDrawerOpen(false)} style={{ fontFamily: 'var(--font-manrope), sans-serif' }}>
              Fale Conosco
            </Link>
          </nav>

          <div className="pb-8 md:pb-12 mt-auto flex items-center justify-start gap-8">
