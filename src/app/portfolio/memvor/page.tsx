  ...
  return (
    <main className="min-h-screen bg-zinc-900 w-full font-sans">
      ...
      <div className="flex flex-col lg:flex-row w-full bg-white">
        ...
        {/* Esquerda: Imagem completa (50%) - Rola naturalmente */}
        <div className="w-full lg:w-1/2 bg-zinc-900">
          <img 
        ...
        {/* Direita: Informações (50%) */}
        <div className="w-full lg:w-1/2 bg-white flex flex-col px-8 py-10 lg:px-16 lg:pt-12 lg:pb-24 xl:px-24">
