        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 md:px-14 lg:px-24 flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="flex-1 min-w-0 w-full max-w-3xl flex flex-col">
            ...
            <>
              ...
              <h4 className="text-lg md:text-xl font-bold text-zinc-800 mb-4">Segurança</h4>
              <p className="text-zinc-600 text-base md:text-lg leading-relaxed mb-6">
            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-zinc-200 pb-6">
                  <h4 className="text-lg md:text-xl font-bold text-zinc-800 mb-3">Qual a diferença entre um site barato e um site profissional?</h4>
                  <p className="text-zinc-600 text-base md:text-lg leading-relaxed">
                ...
                <div className="border-b border-zinc-200 pb-6">
                  <h4 className="text-lg md:text-xl font-bold text-zinc-800 mb-3">WordPress ou Next.js: qual é melhor?</h4>
                  <p className="text-zinc-600 text-base md:text-lg leading-relaxed">
                ...
                <div className="border-b border-zinc-200 pb-6">
                  <h4 className="text-lg md:text-xl font-bold text-zinc-800 mb-3">Domínio e hospedagem estão inclusos no orçamento?</h4>
                  <p className="text-zinc-600 text-base md:text-lg leading-relaxed">
                ...
                <div className="pt-2">
                  <h4 className="text-lg md:text-xl font-bold text-zinc-800 mb-3">Vocês fazem reunião presencial em Duque de Caxias?</h4>
                  <p className="text-zinc-600 text-base md:text-lg leading-relaxed">
