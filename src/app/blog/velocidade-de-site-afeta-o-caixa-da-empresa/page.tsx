        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 md:px-14 lg:px-24 flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="flex-1 min-w-0 w-full max-w-3xl flex flex-col">
            ...
            <div className="mb-12">
              <AudioPlayer 
                title="Ouvir artigo"
                text={`Todo mundo já passou por isso. Você clica em um link, a página começa a carregar, passam dois, três segundos, e nada aparece além de uma tela branca. Na maioria das vezes, o usuário simplesmente sai. Não espera, não dá uma segunda chance. E o Google percebe esse comportamento e usa isso contra o site nos rankings de busca. Performance já saiu do departamento de tecnologia e virou pauta de reunião comercial. Ela impacta diretamente em três coisas que qualquer empresa quer: aparecer no Google, converter visitante em cliente e passar credibilidade. Por que a velocidade pesa tanto no SEO Desde que o Google incorporou os Core Web Vitals como fator de ranqueamento, a métrica de "quão rápido seu site entrega conteúdo útil" ganhou peso oficial nos resultados de busca. Isso inclui três indicadores principais: LCP (Largest Contentful Paint) : tempo até o maior elemento visível da página carregar. INP (Interaction to Next Paint) : tempo de resposta quando o usuário clica ou interage. CLS (Cumulative Layout Shift) : quanto o layout "pula" enquanto a página carrega. Um site que demora demais para responder nesses três pontos tende a perder posição para concorrentes mais rápidos, mesmo com conteúdo parecido. Dois sites podem ter o mesmo texto, as mesmas palavras-chave, a mesma qualidade de escrita, e o mais rápido ainda vai na frente. O que costuma deixar um site lento Na prática, a maioria dos problemas de performance se repete de projeto para projeto: Imagens e vídeos pesados demais. Arquivos exportados direto da câmera ou do design sem nenhuma compressão. Excesso de scripts carregando ao mesmo tempo. Pixels de rastreamento, chats, animações, tudo disputando banda no primeiro carregamento. Hospedagem sem CDN. Servidor único e distante do usuário, aumentando o tempo de resposta. Falta de lazy loading. A página carrega tudo de uma vez, mesmo o que está lá embaixo, fora da tela. Código não otimizado. Bibliotecas inteiras importadas quando só uma função pequena era necessária. Isoladamente, cada um desses pontos parece pequeno. Juntos, formam a diferença entre um site que carrega em menos de dois segundos e outro que trava o usuário por seis, sete segundos. Um exemplo real: o site da Viés Studios Quando estávamos desenvolvendo nosso próprio site institucional, rodamos o PageSpeed Insights e o resultado inicial foi 44 pontos. Um número que deixa claro: por mais bonito que o site esteja, a experiência técnica não estava à altura. O maior vilão eram os vídeos de fundo usados nas seções de destaque. Arquivos grandes, sem compressão adequada, carregando de forma bloqueante. A solução envolveu dois ajustes principais: Compressão dos vídeos usando CloudConvert, reduzindo o peso dos arquivos sem perder qualidade visual perceptível. Lazy loading dos componentes mais pesados usando o next/dynamic , do Next.js, para que elementos fora da área visível só carreguem quando o usuário rolar a página até eles. Resultado: o score subiu de 44 para 83. Quase o dobro, sem trocar uma linha de design, só ajustando como e quando o conteúdo é entregue ao navegador. Basta identificar o gargalo certo e atacar ele direto para conseguir esse tipo de ganho, sem reconstruir nada. Como medir a performance do seu site Antes de qualquer otimização, é preciso saber onde o site está hoje. Algumas ferramentas gratuitas ajudam nisso: Google PageSpeed Insights: mostra a nota de performance em desktop e mobile, além dos Core Web Vitals detalhados. Google Search Console: na seção de Core Web Vitals, mostra como o Google está avaliando as páginas do site com o tempo, com base em dados reais de usuários. Lighthouse (no Chrome DevTools): roda uma auditoria completa direto no navegador, incluindo sugestões específicas de correção. Vale rodar esses testes periodicamente, principalmente depois de adicionar novas seções, imagens ou integrações ao site. Performance pede revisão de tempos em tempos, sobretudo depois de mudanças no site. O que priorizar primeiro Se o objetivo é melhorar a velocidade sem virar o projeto de cabeça para baixo, a ordem de prioridade costuma ser essa: Comprimir e converter imagens e vídeos para formatos modernos (WebP, MP4 otimizado). Aplicar lazy loading em tudo que não aparece na primeira dobra da página. Revisar scripts de terceiros e remover o que não está sendo usado de verdade. Garantir que a hospedagem tenha CDN ativo, distribuindo o conteúdo mais perto do usuário. Monitorar os Core Web Vitals no Search Console com frequência. Velocidade é parte da primeira impressão Um site rápido comunica profissionalismo antes mesmo do usuário ler a primeira frase. Passa a sensação de que a empresa por trás dele cuida dos detalhes, e isso reflete direto na taxa de conversão e na confiança que o visitante deposita na marca. Na Vies Studios, performance entra como critério desde o início do projeto, junto com segurança e SEO. Pensar nisso na estrutura do site sai mais barato do que remendar depois que ele já está no ar cheio de gargalos. Seu site está lento e você não sabe o porquê? Se o seu site demora para carregar, vale rodar um teste no PageSpeed Insights hoje mesmo. Às vezes a diferença entre perder ou ganhar um cliente está em menos de dois segundos de espera. Nós podemos te ajudar a diagnosticar e resolver gargalos de performance que estão travando seus resultados. Falar com especialista`}
              />
            </div>
